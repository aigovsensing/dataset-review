...
<img src="docs/beagle.svg" alt="비글(Beagle) 마스코트" width="150" height="150" />
...
GitHub 이슈에 검토 결과를 등록하는 프로젝트입니다. 냄새 잘 맡는 탐지견 **비글**처럼,
...
3. **결과 열람** — 홈페이지의 **검토 결과** 탭 또는 GitHub 이슈에서 직접 확인합니다.
   ...
   - 📊 **대시보드**: **대시보드** 탭에서 검토 현황을 한눈에 봅니다. 판정별 건수(사용 가능/
     ...
     **확인 결과 · 내부 판단 · 판단 근거**를 열람할 수 있습니다(판정 필터·검색 지원).
     집계 데이터(`docs/data/reviews.json`)는 매일 자동 갱신됩니다.
